...
\noindent Programming language support for concurrent and distributed programming; \\type systems; language and library design; reactive programming
...
\vspace{-0.02in}
\noindent{\bf Committees}: ECOOP 2015 organizing committee (sponsorship chair), POPL 2015 AEC, Scala 2014 (co-chair), Scala 2013 (co-chair)
...
\newline\noindent the college. Initiatives led/introduced:
\vspace{0.05in}
\begin{easylist}[itemize]
