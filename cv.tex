...
\usepackage[total={5.3in,8.75in},top=1.2in, left=1.5in]{geometry}
...
\newcommand{\marginhead}[1]{\reversemarginpar\marginpar{\textsf{{\footnotesize\vspace{-1em}\flushright #1}}}}
...
\noindent{\bf Committees}: Scala 2014 (co-chair), Scala 2013 (co-chair)
