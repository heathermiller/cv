...
\noindent Concurrent, distributed, eventually-consistent (edge computing), data-centric, and data-intensive (big data) programming, from the perspective of programming languages. I work on both theoretical ideas {\em \&} implementations typically in and for the Scala programming language which seek to make it easier to build distributed systems.
\bigskip
\medskip
...
\newline\noindent {\bf \em Executive Director, Research Scientist (permanent)}
...
\newline Rated 4.6 out of 5 stars.
\end{easylist}
\bigskip

\noindent {\bf Instructor, Designer}, {\em CS4240, Large-Scale Parallel Data Processing} \dates{2017}
...
\noindent {\bf Instructor, Designer}, {\em CS7680, Programming Models for Distributed Computation} \dates{2016}
...
\noindent {\bf Instructor, Co-Designer}, {\em Reactive Programming \& Parallelism} \dates{2015 \& 2016}
...
\newline\noindent with >400,000 participants across iterations \& largest completion
...
\newline\noindent Heather Miller, Nat Dempkowski, James Larisch, Christopher Meiklejohn
\smallskip
...
\newline\noindent\href{https://github.com/heathermiller/dist-prog-book}{\em Open Access (draft)} {\em Popular in the developer community, >2,200 stars on GitHub.}
\bigskip
...
\noindent\href{https://infoscience.epfl.ch/record/221395}{\bf The Function Passing Model: Types, Proofs, and Semantics}\dates{}
\newline\noindent Philipp Haller, Normen M\"{u}ller, Heather Miller
\newline\noindent\emph{May 2016}
\medskip

\noindent{\bf Specialising Parsers for Queries}\dates{}
\newline\noindent Manohar Jonnalagedda, Jorge Vicente Cantero, Heather Miller, Martin Odersky
\newline\noindent\emph{April 2016}
\medskip

\noindent\href{https://infoscience.epfl.ch/record/197948}{\bf Improving Human-Compiler Interaction Through Customizable Type Feedback}
\newline\noindent Hubert Plociniczak, Heather Miller, Martin Odersky
\newline\noindent\emph{December 2014}
\medskip

\noindent\href{https://infoscience.epfl.ch/record/199389}{\bf Self-Assembly: Lightweight Language Extension and Datatype Generic Programming, All-in-One!}\dates{}
\newline\noindent Heather Miller, Philipp Haller, Bruno C. d. S. Oliveira
\newline\noindent\emph{August 2014}
\medskip
...
\noindent {\bf Artifact Evaluation Committee:}
\smallskip
\newline\noindent {POPL 2015}
\medskip
...
{\bf Lambda Days} (5/2017, Lisbon, Portugal),
...
\newline\noindent {\'{E}cole Polytechnique F\'{e}d\'{e}rale de Lausanne}
