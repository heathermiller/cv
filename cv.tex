...
\noindent Concurrent, distributed, data-centric, and data-intensive (big data) programming, from the perspective of programming languages. I work on both theoretical ideas on and implementations for the Scala programming language which seek to make it easier to build distributed systems.
...
\newline\noindent POPL 2015 AEC\dates{10/2014}
\newline\noindent Scala Workshop 2014 (Scala'14) (co-chair)\dates{7/2014}
\newline\noindent Scala Workshop 2013 (Scala'13) (co-chair)\dates{7/2013}
