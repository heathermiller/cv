...
\noindent {\bf Lead Teaching Assistant}, {\em Functional Programming Principles in Scala} \dates{2012 --}
\newline\noindent Popular Coursera MOOC on functional programming in Scala
\newline\noindent {\em Role:} One of the lead
\bigskip

\noindent {\bf Lead Teaching Assistant}, {\em Programming Principles} \dates{2012}
\newline\noindent Undergraduate course on introductory functional and logic programming

% course on introductory functional and logic programming\dates{2012}
