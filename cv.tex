...
\noindent{\bf \em EPFL}, \emph{Lausanne, Switzerland} \vspace{0.01in} \dates{9/2009 -- 9/2015}
...
\noindent {\bf Researcher}, {\bf \em Databricks}, \emph{Berkeley, CA, USA} \vspace{0.01in} \dates{8/2014 -- 11/2014}
...
\newline\noindent Developed new function-passing programming model and framework.
\bigskip

\noindent {\bf Research Engineer}, {\bf \em University of Utah}, \emph{Salt Lake City, UT, USA} \vspace{0.01in} \dates{5/2009 -- 8/2009}
\newline\noindent Supervisor: Prof. Dick Normann
\newline\noindent Bioengineering Department, developed a software neural interface to stimulate
\newline\noindent the peripheral nervous system for neuroprosthetics research.
\bigskip

\noindent {\bf Multimedia Engineer}, {\bf \em Arnold Center for Confluent Media Studies},
\newline\noindent \emph{Coral Gables, FL, USA} \vspace{0.01in} \dates{6/2007 -- 12/2008}
\newline\noindent Web development, graphic design, web design, and animation for wide array
\newline\noindent of projects from feature-length films to basic identity design.
\bigskip

\noindent {\bf Research Assistant}, {\bf \em University of Minnesota}, \emph{Minneapolis, MN, USA} \vspace{0.01in} \dates{6/2008 -- 8/2008}
\newline\noindent Supervisor: Prof. Bethanie Stadler
\newline\noindent Electrical and Computer engineering department, worked toward the development
\newline\noindent of an intravascular ultrasound transducer using magnetostrictive nanowires.
\bigskip

\noindent {\bf Electronic Engineer}, {\bf \em Weeks Recording Studio}, \emph{Coral Gables, FL, USA} \vspace{0.01in} \dates{8/2006 -- 8/2008}
\newline\noindent Maintained all electronic studio equipment, from major repairs to installations to cabling.
\bigskip

\noindent {\bf Sound Reinforcement Engineer}, {\bf \em University of Miami Recording Services},
\newline\noindent \emph{Coral Gables, FL, USA} \vspace{0.01in} \dates{1/2006 -- 8/2008}
\newline\noindent Sound reinforcement for wide variety of music acts performing in University of Miami
\newline\noindent concert halls. From solo performances and small ensembles to full orchestras.
\bigskip
...
\noindent{\bf Function Passing: A Model for Typed, Distributed Functional Programming}\dates{}
