...
\noindent{\bf Distributed Programming}\dates{}
...
\marginhead{Publications: \newline In Preparation}
% \medskip

\noindent\href{https://arxiv.org/abs/2502.08966}{\bf RTBAS: Defending LLM Agents Against Prompt Injection and}\dates{arXiv 2025}\vspace{-0.03in}
...
\noindent\href{https://www.caisconf.org/program/2026/papers/vibench-a-benchmark-on-vibe-coding/}{\bf ViBench: A Benchmark on Vibe Coding}\dates{CAIS 2026}
\newline\noindent Peter Zhong, Pashootan Vaezipoor, Fuyang Cui, Vaibhav Kumar,\vspace{-0.03in}
\newline\noindent James Austin, Azin Asgarian, Toby Ho, Paul Inder, Imen Kedir, Zhen Li,\vspace{-0.03in}
\newline\noindent Nicholas Ondo, Asna Shafiq, Ibrahim Sheikh, Edouard Sioufi, Setareh Soltanieh,\vspace{-0.03in}
\newline\noindent Ben Wilde, Jacky Zhao, Ryan Carelli, Heather Miller, Michele Catasta
\newline\noindent\emph{ACM Conference on AI and Agentic Systems}
\bigskip

\newpage

\noindent\href{https://www.arxiv.org/abs/2504.20192}{\bf Debugging WebAssembly? Put some Whamm on it!}\dates{OOPSLA 2025}
...
\noindent\href{https://openreview.net/forum?id=GbgCRJedQ7}{\bf SMT: Fine-Tuning Large Language Models with Sparse Matricies}\dates{ICLR 2025}\vspace{-0.03in}
...
%\smallskip
\newline\noindent {\em \href{https://caisconf.org}{Inaugural ACM Conference on AI and Agentic Systems}} {(\textbf{ACM CAIS})} \dates{2026}
...
\noindent {\bf Program Committee Invitations Refused or Commitees Dropped Out Of:}
EuroSys'26, USENIX ATC ERC '25, Onward Papers'25, PLDI'25, SoCC'24, PaPoC'24, Onward Papers'24, SoCC'23, OOPSLA'23, Onward Essays'22
\medskip

\noindent {\bf Program Committee Member:}
%\smallskip
\newline\noindent {\em European Conference on Object-Oriented Programming} {(\textbf{ECOOP})} \dates{2024}
\newline\noindent {\em International Conference on Architectural Support for} \vspace{-0.03in} \dates{2023}
\newline\noindent {\em Programming Languages and Operating Systems} {(\textbf{ASPLOS})} 
\newline\noindent {\em ACM Symposium on Cloud ComputingEngineering} {(\textbf{SoCC})} \dates{2022}
...
\noindent {\bf \href{https://gulang2019.github.io/}{Siyuan Chen}} (co-advised with Phil Gibbons and Ben L. Titzer) \dates{2023 --}
