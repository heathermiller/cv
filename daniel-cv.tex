...
\def\myaddress{Department of Philosophy \& Media Studies \\ Seminar for Media Studies}
\def\myemail{Daniel.Klug@unibas.ch}
\def\myweb{https://populaerkultur.unibas.ch}
...
\noindent\textbf{Lip Synching in Musikclips. Zur Konstruktion von Audio-Vision}\dates{2013}\vspace{-0.03in}
...
\noindent{\bf Popul\"{a}re Musik, mediale Musik? Transdisziplin\"{a}re Beitr\"{a}ge zu}\dates{2011}\vspace{-0.03in}
\newline\noindent{\bf den Medien der popul\"{a}ren Musik}
% \smallskip
...
\noindent{\bf Computer-based Analysis of Audiovisual Media Artifacts in}\dates{2015}
\newline\noindent{\bf School Music Lessons, In: Teaching Music in the 21st Century (in print)}
\newline\noindent {\em Computergest\"{u}tzte Analyse von audiovisuellen Medienangeboten}
...
\noindent{\bf Scripted Reality-Shows in German-speaking Television Programs.}\dates{2014}
\newline\noindent{\bf Tri-National Program Analysis and the Concept of a Combined Analysis}
\newline\noindent{\bf of Product and Production}
\newline\noindent {\em Scripted Reality-Formate im deutschsprachigen Fernsehprogramm.} 
\newline\noindent {\em Trinationale Programmanalyse und Konzeption einer kombinierten}
...
\noindent{\bf The Body (and Its Representations) in Factual Entertainment.}\dates{2014}
\newline\noindent{\bf  Producing Reality in and Beyond Television}
\newline\noindent {\em K\"{o}rper(-Darstellungen) im Reality-TV. Herstellung von Wirklichkeit} 
...
\noindent{\bf (In-)Coherences. On the Performative Practice of Lip Synching in}\dates{2011}
\newline\noindent{\bf the Audio-Vision of Music Videos}
\newline\noindent{\em (Un-)Stimmigkeiten. Zur Darstellungspraxis des lip synching in} 
...
\noindent{\bf ...dont be afraid, don't have no fear -- Horror Aesthetics in the Pop}\dates{2010}
\newline\noindent{\bf Music Video ``Everybody (Backstreet's back)''}
\newline\noindent{\em '...don’t be afraid, don’t have no fear' – Horror\"{a}sthetik im Popmusikclip}
...
\noindent{\bf Integrated Analysis of Image, Text, and Sound. The Example of the}\dates{2009}
...
\noindent{\bf The Song in the Context of Audio Vision. Introduction to a}\dates{2009}
...
\noindent{\bf The Pedagogical Concept of Peer Education in the Context of}\dates{2012}
\newline\noindent{\bf Media Literacy Advancement and Youth Media Protection}
\newline\noindent{\em Das p\"{a}dagogische Konzept der Peer Education im Rahmen von}
\newline\noindent{\em Medienkompetenzf\"{o}rderung und Jugendmedienschutz}
% \smallskip
\newline\noindent Klaus Neumann-Braun, Vanessa Kleinschnittger, Michael Baumg\"{a}rtner,
...
\noindent{\bf Risk Factors in Young People’s Use of Digital Media and Possible }\dates{2012}
\newline\noindent{\bf Strategies in the Context of Prevention and Intervention}
\newline\noindent{\em Risikofaktoren bei der Nutzung digitaler Medien durch Jugendliche und m\"{o}gliche}
...
\noindent{\bf The Construction of Images Including a Capability for Truth -- Production}\dates{2015}
\linebreak\noindent{\bf Techniques in Factual Entertainment} \dates{}
\linebreak\noindent {\em Die Herstellung wahrheitsfähiger Bilder – Produktionstechniken}\dates{}
...
\noindent{\bf Displaying the Self through Moving Images. Functions and Consequences of}\dates{2014}
...
\noindent{\bf Entertainment Television Between Fact and Fiction: Comparative Analysis of}\dates{2014}
\linebreak\noindent{\bf the Product, Production, and Perception of Scripted Reality Shows}\dates{}
\linebreak\noindent{\em Zwischen fiktionaler und faktualer Fernsehunterhaltung: Vergleichende}\dates{}
...
\linebreak\noindent Annual Conference of the History of Television/Television Studies Division of\dates{} 
...
\noindent{\bf Analyzing Television Products Using the Transcription Tool trAVis:}
\dates{2013}
...
\noindent{\bf trAVis - Transcribing Music-Based Audiovisual Media Through}
\dates{2012}
...
\noindent{\bf Computer-based Integrated Analysis of Images, Text, and Sound in}
\dates{2011}
...
\noindent{\bf Intermedia Structures in Music Videos. Towards an Integrated Analysis}\dates{2009}
\linebreak\noindent{\bf of Images, Text, and Sound, Illustrated With the Music Video ``Californication''}\dates{}
\linebreak\noindent{\em Intermediale Strukturen im Musikclip. Auf dem Weg zu einer integrierten}\dates{} 
...
\noindent {\bf Computer-based Analysis of Audio Visual Media Artifacts Using the}\dates{2013 --} 
\newline\noindent{\bf Web Application trAVis}\dates{}
\newline\noindent {\em Computergest\"{u}tzte Analyse audiovisueller Medienprodukte mit der} 
